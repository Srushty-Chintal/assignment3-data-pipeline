...
class S3Service:
    ...
    def get_object_details(
        ...
        # Add VersionId only when it is available.
        if version_id:
        ...
        actual_version_id = head_response.get("VersionId")

        if not actual_version_id:
            actual_version_id = version_id or "null"
